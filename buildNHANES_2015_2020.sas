...
data combI;
set combI;
WTINT52YR=(2/5.2)*WTINT2YR;
WTINT92YR=(2/9.2)*WTINT2YR;
run;

*2017-2020;
*SLQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_SLQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_SLQ;
set P_SLQ;
...
*DEMO;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_DEMO.xpt';
proc copy inlib=xptfile outlib=work;
run;

*BMX;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_BMX.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_BMX;
set P_BMX;
...
*MCQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_MCQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_MCQ;
set P_MCQ;
keep SEQN MCQ160K MCQ160g MCQ160o MCQ160f MCQ160d MCQ160b MCQ160c MCQ160e
MCQ010 MCQ035 MCQ220 MCQ160b MCQ160c MCQ160e MCQ160l MCQ160f MCQ160p;
array setmis(*) MCQ160K MCQ160g MCQ160o MCQ160f MCQ160d MCQ160b MCQ160c MCQ160e
MCQ010 MCQ035 MCQ220 MCQ160b MCQ160c MCQ160e MCQ160l MCQ160f MCQ160p;
	do i=1 to dim(setmis);
		if setmis(i)>2 then setmis(i)=.;
...
*BPQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_BPQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_BPQ;
set P_BPQ;
...
*HUQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_HUQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_HUQ;
set P_HUQ;
...
*HIQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_HIQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_HIQ;
set P_HIQ;
...
run;
*DIQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_DIQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_DIQ;
set P_DIQ;
...
run;
*SMQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_SMQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_SMQ;
set P_SMQ;
...
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_INQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_INQ;
set P_INQ;
...
*RHQ;
libname xptfile xport 'C:\Users\PWS5\OneDrive - University of Pittsburgh\Desktop\SleepHUB\P_RHQ.xpt';
proc copy inlib=xptfile outlib=work;
run;
data P_RHQ;
set P_RHQ;
...
proc sql;
   ...
   inner join P_MCQ
   on P_SLQ.SEQN = P_MCQ.SEQN
   inner join P_BMX
   on P_MCQ.SEQN=P_BMX.SEQN
   inner join P_BPQ
   on P_BMX.SEQN=P_BPQ.SEQN
   inner join P_HUQ
   on P_BPQ.SEQN=P_HUQ.SEQN
   inner join P_HIQ
   on P_HUQ.SEQN=P_HIQ.SEQN
   inner join P_SMQ
   on P_HIQ.SEQN=P_SMQ.SEQN
   inner join P_INQ
   on P_SMQ.SEQN=P_INQ.SEQN
   inner join P_DIQ
   on P_INQ.SEQN=P_DIQ.SEQN
   full outer join P_RHQ
   on P_DIQ.SEQN=P_RHQ.SEQN;
quit;
data combJ;
set combJ;
WTINT52YR=(3.2/5.2)*WTINTPRP;
WTINT92YR=(3.2/9.2)*WTINTPRP;
run;
*pull together 2005-2008;
data comb58;
set combD combE (rename=(RHD042=RHD043));
run;
...
if (INDFMMPI<1.3) then FPR3=0;
if ((INDFMMPI>=1.3) & (INDFMMPI<3.5)) then FPR3=1;
if INDFMMPI>=3.5 then FPR3=2;
...
if RIDAGEYR>=40 & RIDAGEYR<=49 then AgeCat=1;
if RIDAGEYR>49 & RIDAGEYR<=64 then AgeCat=2;
if RIDAGEYR>64 then AgeCat=3;
 run; 
...
set comb1518over40m;
if ((MCQ160K=1) or (MCQ160G=1) or (MCQ160O=1) or (MCQ160p=1)) then COPD=1;
else COPD=0;
if BMXBMI>=40 then Obese=1;
else Obese=0;
if MCQ160f=1 | MCQ160d=1 | MCQ160b=1 | MCQ160c=1 | MCQ160e=1 | BPQ020=1
...
proc format;
value fpr3lab
0='High Economic Hardship (<130%)'
1='Moderate Economic Hardship (130%-349%)'
2='Economic Soundness (>=350%)'
;
proc format;
value edu2lab
0='less than HS'
...
if (SDDSRVYR=9 | SDDSRVYR=66) then Cohort=2;
if GroupOverlap=1 then ToS=1;
if GroupOverlap>1 then ToS=0;
if GroupOverlap=. then ToS=.;
run;
